  ...
  return (
    ...
    >
      <div className="mb-14">
        ...
        <p className="font-display text-[clamp(1.2rem,2.6vw,1.75rem)] font-bold leading-tight tracking-tight">
          built when bored.
        </p>
          ...
          <li key={p.title}>
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                <span className="font-display text-[clamp(1.4rem,3vw,2.2rem)] font-bold leading-[1.05] tracking-tight transition-colors duration-300 ease-quint group-hover:text-[var(--hot)] group-focus-visible:text-[var(--hot)]">
                  {p.title}
                </span>
